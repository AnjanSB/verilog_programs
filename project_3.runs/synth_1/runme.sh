...
HD_PWD='C:/Users/Sree Anjan/verilog/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TLs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TLs.tcl
